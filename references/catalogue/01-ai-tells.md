...
The counts above are the *historical* source-catalogue figures, frozen at the 2026-07-07 merge. **Current totals are carried by the section headings themselves and are authoritative there:** 94 numbered base tells across sections 1-8 (C18, T14, L13, S12, W10, M7, I7, U13), 12 user-flagged visual tells (V1-V12), 35 platform tells (P15 / A10 / AM10), 20 Deep Cuts (D1-D20), plus the Strongest-10 ranks and the section-11 fingerprints. When you add a tell, update its section heading count and this line in the same edit.
...
## 9. Specific Visual Tells (user-flagged) (12)
